...
public class TransactionsDemo {
    ...
    private static void inserOrderItem(Connection conn, int orderId, String productName, int quantity, double price) {
...
//            int x = 10/0;
            ...
            System.out.println("INSERTED into order_item : "+rows);
        }catch (SQLException e) {
